    ...
    if ($username == '' && $password == '') {
        ...
        if (!empty($row['id'])) {
            if (($row['password'] == $func->encryptPassword($config['website']['secret'], $password, $config['website']['salt']))) {
                ...
                /* Tạo Session login */
                $_SESSION[$loginAdmin]['owner']['active'] = true;
                $_SESSION[$loginAdmin]['owner']['username'] = $row['username'];
                $_SESSION[$loginAdmin]['owner']['id'] = $row['id'];
                $_SESSION[$loginAdmin]['owner']['role'] = $row['role'];
                $_SESSION[$loginAdmin]['owner']['virtual'] = (!empty($row['status']) && strstr($row['status'], 'virtual')) ? true : false;
                $_SESSION[$loginAdmin]['owner']['secret_key'] = $row['secret_key'];
                $_SESSION[$loginAdmin]['owner']['token'] = $sessionhash;
                $_SESSION[$loginAdmin]['owner']['password'] = $row['password'];
                $_SESSION[$loginAdmin]['owner']['login_session'] = $sessionhash;
                ...
                $secret_key = $_SESSION[$loginAdmin]['owner']['token'];
