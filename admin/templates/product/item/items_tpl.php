...
<section class="content">
    ...
    <div class="card-footer form-group-category text-sm bg-light row">
        ...
        <div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2">
            <label class="d-block">Danh mục cấp</label>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['namevi'] ?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?= THUMBS ?>/<?= $config['product']['thumb_item'] ?>/<?= UPLOAD_PRODUCT_L . $items[$i]['photo'] ?>" alt="<?= $items[$i]['namevi'] ?>"></a>
                                </td>
                                <?php /* ?>
                                <td class="align-middle">
                                    <a href="<?=$linkEdit?><?=$linkID?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['namevi']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['product']['thumb2_item']?>/<?=UPLOAD_PRODUCT_L.$items[$i]['photo2']?>" alt="<?=$items[$i]['namevi']?>"></a>
                                </td>
                                <?php */ ?>
                                <td class="align-middle">
