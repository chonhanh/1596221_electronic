<?php
$linkMan = "index.php?com=product&act=man_tags";
$linkSave = "index.php?com=product&act=save_tags";
?>
<!-- Content Header -->
...
<section class="content">
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <?php
                        $photoDetail = UPLOAD_TAGS . @$item['photo'];
                        $dimension = "Width: " . $config['product']['width_tags'] . " px - Height: " . $config['product']['height_tags'] . " px (" . $config['product']['img_type_tags'] . ")";
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php
                $seoDB = $seo->getOnDB('*', 'product_tags_seo', $id);
