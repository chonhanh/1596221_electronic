...
$linkMan = "index.php?com=store&act=man";
if ($act == 'add') $linkFilter = "index.php?com=store&act=add";
else if ($act == 'edit') $linkFilter = "index.php?com=store&act=edit&id=" . $id;
$linkSave = "index.php?com=store&act=save";
?>
<!-- Content Header -->
...
<section class="content">
    <form method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        <div class="card-footer text-sm sticky-top">
            <button type="submit" class="btn btn-sm bg-gradient-primary submit-store"><i class="far fa-save mr-2"></i>Lưu</button>
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        <div class="form-group-category row">
                            <div class="form-group col-xl-6 col-sm-4">
                                ...
                                <?= $func->getAjaxCategory('product', 'list', true) ?>
                            </div>
                            <div class="form-group col-xl-6 col-sm-4">
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <?php
                        $photoDetail = UPLOAD_STORE . @$item['photo'];
                        $dimension = "Width: " . $config['store']['width'] . " px - Height: " . $config['store']['height'] . " px (" . $config['store']['img_type'] . ")";
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php
                $seoDB = $seo->getOnDB("*", 'store_seo', $id);
