...
<HEAD>
    ...
    <meta http-equiv="REFRESH" content="4.5; url=<?= strpos($page_transfer, "http") === 0 ? $page_transfer : $basehref . ADMIN . "/" . $page_transfer ?>">
...
<BODY>
    <div id="alert">
        ...
        <div class="rlink">(<a href="<?= strpos($page_transfer, "http") === 0 ? $page_transfer : ADMIN . "/" . $page_transfer ?>">Click vào đây nếu không muốn đợi lâu</a>)</div>
        <div class="progress">
