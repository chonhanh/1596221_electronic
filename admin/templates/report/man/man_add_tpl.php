...
$linkSave = "index.php?com=report&act=save";
?>
<!-- Content Header -->
                            ...
                            <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control for-seo text-sm" name="data[desc<?= $k ?>]" id="desc<?= $k ?>" rows="5" placeholder="Mô tả (<?= $k ?>)" required><?= $func->decodeHtmlChars($flash->get('desc' . $k)) ?: $func->decodeHtmlChars(@$item['desc' . $k]) ?></textarea>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
