<?php
$linkMan = "index.php?com=places&act=man_wards";
if ($act == 'add_wards') $linkFilter = "index.php?com=places&act=add_wards";
else if ($act == 'edit_wards') $linkFilter = "index.php?com=places&act=edit_wards&id=" . $id;
$linkSave = "index.php?com=places&act=save_wards";
?>
<!-- Content Header -->
            ...
            <div class="card-body">
                <div class="form-group-category row">
                    <div class="form-group col-md-3 col-sm-4">
                        <label class="d-block" for="id_region">Danh sách vùng miền:</label>
