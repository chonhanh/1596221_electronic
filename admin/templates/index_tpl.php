    ...
    <section class="content mb-3">
        <div class="container-fluid">
            ...
            <div class="row mb-2 text-sm">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <a class="my-info-box info-box" href="index.php?com=newsletter&act=man&type=phan-hoi" title="Thư liên hệ">
                        <span class="my-info-box-icon info-box-icon bg-info"><i class="fas fa-address-book"></i></span>
                        <div class="info-box-content text-dark">
                            <span class="info-box-text text-capitalize">Thư phản hồi</span>
                            <span class="info-box-number">View more</span>
                        </div>
                    </a>
                </div>
