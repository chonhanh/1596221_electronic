            ...
            <div class="input-group align-items-center captcha-image mb-3">
                ...
                <div class="input-group-append">
                    <span class="input-group-text text-sm rounded-0 border-0">
                        <img onerror="this.src='<?= THUMBS ?>/80x30x1/assets/images/noimage.png';" src="<?= BASE_MAIN ?>captcha/<?= base64_encode('contact-' . NAME_SHOP) ?>/" alt="Mã bảo mật" />
                        <a class="captcha-reload ml-2" href="javascript:void(0)" data-type="contact-<?= NAME_SHOP ?>">
