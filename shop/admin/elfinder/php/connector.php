...
if(empty($token) || empty($_SESSION[$token]['active']))
{
	die("Access denied");
}
...
$pathToFile = '../../../../upload/filemanager/'.$_SESSION[$token]['folder'].'/';
$urlToFile = dirname(dirname(str_replace('elfinder/php/', '', baseUrl()))).'/upload/filemanager/'.$_SESSION[$token]['folder'].'/';
