...
<?php if (!empty($config['news'])) { ?>
    ...
    <li class="nav-item has-treeview <?= $menuopen ?>">
        ...
        <ul class="nav nav-treeview">
            ...
            <!-- <?= $config['news']['dich-vu']['title_main'] ?> -->
            <?php
            $active = "";
            $array_act = array('man', 'add', 'edit');

            /* check active */
            if (($com == 'news') && ($type == 'dich-vu') && (in_array($act, $array_act))) {
                $active = "active";
            }
            ?>
            <li class="nav-item">
                <a class="nav-link <?= $active ?>" href="index.php?com=news&act=man&type=dich-vu" title="<?= $config['news']['dich-vu']['title_main'] ?>">
                    <i class="nav-icon text-sm far fa-caret-square-right"></i>
                    <p><?= $config['news']['dich-vu']['title_main'] ?></p>
                </a>
            </li>
    ...
    <li class="nav-item has-treeview <?= $menuopen ?>">
        ...
        <ul class="nav nav-treeview">
            ...
            <?php if (!empty($config['photo']['man_photo'])) { ?>
                ...
                <!-- <?= $config['photo']['man_photo']['advertise']['title_main_photo'] ?> -->
                <?php
                $active = "";
                $array_act = array('man_photo', 'add_photo', 'edit_photo');

                /* check active */
                if (($com == 'photo') && ($_GET['type'] == 'advertise') && (in_array($act, $array_act))) {
                    $active = "active";
                }
                ?>
                <li class="nav-item">
                    <a class="nav-link <?= $active ?>" href="index.php?com=photo&act=man_photo&type=advertise" title="<?= $config['photo']['man_photo']['advertise']['title_main_photo'] ?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                        <p><?= $config['photo']['man_photo']['advertise']['title_main_photo'] ?></p>
                    </a>
                </li>

                <!-- <?= $config['photo']['man_photo']['video']['title_main_photo'] ?> -->
                <?php
                $active = "";
                $array_act = array('man_photo', 'add_photo', 'edit_photo');

                /* check active */
                if (($com == 'photo') && ($_GET['type'] == 'video') && (in_array($act, $array_act))) {
                    $active = "active";
                }
                ?>
                <li class="nav-item">
                    <a class="nav-link <?= $active ?>" href="index.php?com=photo&act=man_photo&type=video" title="<?= $config['photo']['man_photo']['video']['title_main_photo'] ?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                        <p><?= $config['photo']['man_photo']['video']['title_main_photo'] ?></p>
                    </a>
                </li>

                <!-- <?= $config['photo']['man_photo']['partner']['title_main_photo'] ?> -->
                <?php
                $active = "";
                $array_act = array('man_photo', 'add_photo', 'edit_photo');

                /* check active */
                if (($com == 'photo') && ($_GET['type'] == 'partner') && (in_array($act, $array_act))) {
                    $active = "active";
                }
                ?>
                <li class="nav-item">
                    <a class="nav-link <?= $active ?>" href="index.php?com=photo&act=man_photo&type=partner" title="<?= $config['photo']['man_photo']['partner']['title_main_photo'] ?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                        <p><?= $config['photo']['man_photo']['partner']['title_main_photo'] ?></p>
                    </a>
                </li>
...
<?php if (!empty($config['seopage'])) { ?>
    ...
    <li class="nav-item has-treeview <?= $menuopen ?>">
        ...
        <ul class="nav nav-treeview">
            ...
            <!-- <?= $config['seopage']['page']['san-pham-ban-chay'] ?> -->
            <?php
            $active = "";

            /* check active */
            if (($com == 'seopage') && ($_GET['type'] == 'san-pham-ban-chay')) {
                $active = "active";
            }
            ?>
            <li class="nav-item">
                <a class="nav-link <?= $active ?>" href="index.php?com=seopage&act=update&type=san-pham-ban-chay" title="<?= $config['seopage']['page']['san-pham-ban-chay'] ?>">
                    <i class="nav-icon text-sm far fa-caret-square-right"></i>
                    <p><?= $config['seopage']['page']['san-pham-ban-chay'] ?></p>
                </a>
            </li>
