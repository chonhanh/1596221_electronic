...
<HEAD>
    ...
    <meta http-equiv="REFRESH" content="4.5; url=<?= $basehref . $nameshop . '/' . ADMIN . '/' . $page_transfer ?>">
...
<BODY>
    <div id="alert">
        ...
        <div class="rlink">(<a href="<?= $basehref . $nameshop . '/' . ADMIN . '/' . $page_transfer ?>">Click vào đây nếu không muốn đợi lâu</a>)</div>
        <div class="progress">
