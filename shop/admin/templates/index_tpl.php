...
<section class="content mb-3">
    <div class="container-fluid">
        ...
        <div class="row mb-2 text-sm">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <a class="my-info-box info-box" href="index.php?com=product&act=man" title="Tin đăng">
                    <span class="my-info-box-icon info-box-icon bg-danger"><i class="fas fa-boxes"></i></span>
                    <div class="info-box-content text-dark">
                        <span class="info-box-text text-capitalize">Tin đăng</span>
                        <span class="info-box-number">View more</span>
                    </div>
                </a>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <a class="my-info-box info-box" href="index.php?com=static&act=update&type=footer" title="Footer">
                    <span class="my-info-box-icon info-box-icon bg-success"><i class="far fa-newspaper"></i></span>
                    <div class="info-box-content text-dark">
                        <span class="info-box-text text-capitalize">Footer</span>
                        <span class="info-box-number">View more</span>
                    </div>
                </a>
            </div>
        ...
        var options = {
            ...
            series: [{
                ...
                data: [
                    <?php for ($i = 1; $i <= $daysInMonth; $i++) {
                        ...
                        $todayrc = $d->rawQueryOne("select count(*) as todayrecord from #_$tableShopCounter where id_shop = $idShop and tm >= ? and tm < ?", array($begin, $end));
            ...
            labels: [
                <?php for ($i = 1; $i <= $daysInMonth; $i++) {
                    ...
                    $end = strtotime($year . '-' . $month . '-' . $k);
                    $todayrc = $d->rawQueryOne("select count(*) as todayrecord from #_$tableShopCounter where id_shop = $idShop and tm >= ? and tm < ?", array($begin, $end));
                    $today_visitors = $todayrc['todayrecord']; ?> 'D<?= $i ?>',
                <?php } ?>
            ],
            legend: {
                position: 'top',
