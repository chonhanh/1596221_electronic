<?php
$linkMan = "index.php?com=product&act=man_item";
if ($act == 'add_item') $linkFilter = "index.php?com=product&act=add_item";
else if ($act == 'edit_item') $linkFilter = "index.php?com=product&act=edit_item&id=" . $id;
$linkSave = "index.php?com=product&act=save_item";
?>
<!-- Content Header -->
...
<section class="content">
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <?php
                        $photoDetail = UPLOAD_PRODUCT_ADMIN . @$item['photo'];
                        $dimension = "Width: " . $config['product']['width_item'] . " px - Height: " . $config['product']['height_item'] . " px (" . $config['product']['img_type_item'] . ")";
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <?php
                            $photoDetail2 = UPLOAD_PRODUCT_ADMIN.@$item['photo2'];
                            $dimension2 = "Width: ".$config['product']['width2_item']." px - Height: ".$config['product']['height2_item']." px (".$config['product']['img_type_item'].")";
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php
                $seoDB = $seo->getOnDB('*', 'product_item_seo', $id);
