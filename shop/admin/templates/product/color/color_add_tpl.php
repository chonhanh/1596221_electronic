...
$linkSave = "index.php?com=product&act=save_color";
?>
<!-- Content Header -->
    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title"><?= ($act == "edit_color") ? "Cập nhật" : "Thêm mới"; ?> màu sắc</h3>
            </div>
            <div class="card-body">
                <?php if (isset($config['product']['color_images']) && $config['product']['color_images'] == true) { ?>
                    <div class="form-group">
                        <div class="upload-file">
                            ...
                            <strong class="d-block text-sm"><?php echo "Width: " . $config['product']['width_color'] . " px - Height: " . $config['product']['height_color'] . " px (" . $config['product']['img_type_color'] . ")" ?></strong>
                        </div>
                    </div>
                <?php } ?>
                <div class="row">
                    <?php if (isset($config['product']['color_code']) && $config['product']['color_code'] == true) { ?>
                    ...
                    <?php } ?>
                    <?php if (
                        (isset($config['product']['color_type']) && $config['product']['color_type'] == true) &&
                        (isset($config['product']['color_images']) && $config['product']['color_images'] == true)
                    ) { ?>
                        <div class="form-group col-md-3 col-sm-4">
