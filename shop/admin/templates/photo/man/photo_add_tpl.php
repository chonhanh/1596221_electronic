            ...
            <div class="card card-primary card-outline text-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-mini d-inline-block align-middle" min="0" name="dataMulti[<?= $i ?>][numb]" id="numb<?= $i ?>" placeholder="Số thứ tự" value="1">
                    </div>
