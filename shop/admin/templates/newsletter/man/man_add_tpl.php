            ...
            <div class="card-body">
                ...
                <?php if (isset($config['newsletter'][$type]['content']) && $config['newsletter'][$type]['content'] == true) { ?>
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-sm" name="data[content]" id="content" rows="5" placeholder="Nội dung" required><?= $func->decodeHtmlChars($flash->get('content')) ?: $func->decodeHtmlChars(@$item['content']) ?></textarea>
                    </div>
                <?php } ?>
                <?php if (isset($config['newsletter'][$type]['notes']) && $config['newsletter'][$type]['notes'] == true) { ?>
                    <div class="form-group">
                        <label for="notes">Ghi chú:</label>
                        <textarea class="form-control text-sm" name="data[notes]" id="notes" rows="5" placeholder="Ghi chú"><?= $func->decodeHtmlChars($flash->get('notes')) ?: $func->decodeHtmlChars(@$item['notes']) ?></textarea>
                    </div>
                <?php } ?>
                <div class="form-group">
