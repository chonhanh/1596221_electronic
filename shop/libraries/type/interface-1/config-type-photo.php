...
/* Header */
$nametype = "header";
$config['photo']['photo_static'][$nametype]['title_main'] = "Header";
...
$config['photo']['photo_static'][$nametype]['thumb'] = '1366x115x2';
...
$config['photo']['photo_static'][$nametype]['thumb'] = '160x100x2';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
...
$config['photo']['photo_static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['photo']['photo_static'][$nametype]['images'] = true;
$config['photo']['photo_static'][$nametype]['width'] = 560;
$config['photo']['photo_static'][$nametype]['height'] = 90;
$config['photo']['photo_static'][$nametype]['thumb'] = '560x90x2';
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif';
