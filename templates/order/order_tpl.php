<form id="form-cart" method="post" action="" enctype="multipart/form-data">
    ...
    <?php if (!empty($_SESSION['owner']['cart'])) { ?>
        ...
        <div class="form-row">
                                                ...
                                                <div class="info-procart col-6">
                                                    <div class="d-flex align-items-start justify-content">
                                                        <div class="image-procart text-center">
                                                            ...
                                                            <a class="delete-procart small text-danger text-decoration-none" href="javascript:void(0)" data-group-code="<?= $v_group_cart['infos']['code'] ?>" data-code="<?= $code ?>" title="Xóa"><i class="far fa-trash-alt mr-1"></i>Xóa</a>
                                                        </div>
            ...
            <div class="right-cart col-lg-4 col-12">
