<!-- Videos seen -->
<?php if (!empty($videoSeen)) { ?>
    <div class="block-video-seen mt-5">
        <div class="title-main"><span>Video đã xem</span></div>
        <div class="position-relative">
            <div class="owl-page owl-carousel owl-theme" data-items="screen:0|items:4|margin:20" data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1" data-touchdrag="1" data-smartspeed="500" data-autoplayspeed="500" data-autoplaytimeout="5000" data-autoplayhoverpause="1" data-dots="0" data-nav="1" data-navcontainer=".control-video-seen">
                <?php foreach ($videoSeen as $k_video => $v_video) {
            ...
            <div class="control-video-seen control-owl transition <?= (count($videoSeen) <= 4) ? 'd-none' : '' ?>"></div>
        </div>
    </div>
<?php } ?>